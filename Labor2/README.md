# Laboratory 2 for Computer Architecture
This directory contains the template for Lab2 in Computer Architecture.
...
You *must* then open the lab2a Directory in it's *own*, *new* VScode window!
